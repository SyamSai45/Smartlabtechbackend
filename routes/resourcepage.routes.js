...
router.get('/articles', protect, authorize('admin'), getArticlesSection);
...
router.get('/pdfs', protect, authorize('admin'), getPdfsSection);
...
router.get('/case-studies', protect, authorize('admin'), getCaseStudiesSection);
...
router.get('/faqs', protect, authorize('admin'), getFaqsSection);
...
router.get('/achievements', protect, authorize('admin'), getAchievementsSection);
...
router.get('/cta', protect, authorize('admin'), getCtaSection);
